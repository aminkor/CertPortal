...
{
    public partial class CertPortal_DevContext : DbContext
    {
        public CertPortal_DevContext()
        {
        }

        public CertPortal_DevContext(DbContextOptions<CertPortal_DevContext> options)
            : base(options)
        {
        }
